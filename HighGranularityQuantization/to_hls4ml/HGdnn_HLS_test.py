...
hls_model.write()  # just writes the HLS project files
hls_model.compile()  # compiles the model for C/RTL simulation

print("HLS project files written to:", os.path.abspath(output_dir))
# ==========
# 7. Test predictions
# ==========
...
print("\nSimulating HLS predictions (bit-accurate)...")
hls_preds = hls_model.predict(x_test[:5])
print("HLS model predictions:")
print(hls_preds)
print("Predicted classes:", tf.argmax(hls_preds, axis=1).numpy())
